...
const cmiPageTitle = {
  ...
  popover: {
    title: "Title",
    description: "This is the homepage for <em>The Impersonal Life</em> by Joseph Benner in the Christ Mind Library.<br><br>Click on the book cover below to see the table of contents.",
    position: "bottom"
  }
};
...
const cmiPageBanner = {
  ...
  popover: {
    ...
    description: "<em>The Impersonal Life</em> is part of the Library of Christ Mind Teachings. On every page you can click on this banner to navigate to the Library's main page and see all available teachings.",
    position: "bottom"
  }
};

const theImpersonalLife = {
  element: "[data-book='til']",
  popover: {
    title: "The Impersonal Life",
    description: "By Joseph S. Benner, originally published in 1914. Audio is available and offered by Barry Peterson.",
    position: "top"
  }
};
...
export function pageNavigationDriver() {
  ...
  let pageNavigationDriverSteps = [];

  pageNavigationDriverSteps.push(cmiPageBanner);
  pageNavigationDriverSteps.push(pageMenu);
  pageNavigationDriverSteps.push(pageMenuBookmarkItem);
  ...
  driver.defineSteps(pageNavigationDriverSteps);
  driver.start();
}
